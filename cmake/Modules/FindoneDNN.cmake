...
# find_library(ZE_LOADER_LIBRARY
#     NAMES ze_loader
#     PATHS "${CONDA_PREFIX}/Library/lib"
#     NO_DEFAULT_PATH
# )

# message(STATUS "find ZE_LOADER_LIBRARY: ${ZE_LOADER_LIBRARY}")
...
# target_link_libraries(${ONEDNN_LIBRARY} PRIVATE ${ZE_LOADER_LIBRARY})
target_link_libraries(${ONEDNN_LIBRARY} 
    PRIVATE "C:/Users/arda/miniforge3/envs/xin-vllm-xpu/Library/lib/ze_loader.lib"
)
